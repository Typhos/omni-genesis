...
export default class Name {
  ...
  buildDwarfName() {
    ...
    if ( Utils.randomInt(1, 2) === 1 ) {
      ...
      let firstName = Names.dwarven.first[this.sex][ Utils.randomArrayIndex( Names.dwarven.first[this.sex].length) ];
      let frontCompound = Names.dwarven.last.frontCompound[ Utils.randomArrayIndex( Names.dwarven.last.frontCompound.length) ];
      let backCompound = Names.dwarven.last.backCompound[ Utils.randomArrayIndex( Names.dwarven.last.backCompound.length) ];;
  ...
  buildGnomeName() {
    ...
    if (method==="xge") {
      const firstName = nameLenArr.map( x => {
